...
export class InstitutionController {
  ...
  @ApiOperation({
    summary: 'Get institution details including members and active certificate',
  })
  ...
  @ApiParam({ name: 'institutionId', type: String })
  @ApiOperation({
    summary: 'Add an ID-verified user as a member — institution admin only',
  })
  addMember(
  ...
  @ApiOperation({
    summary:
      'Grant stamp authority to a member — requires an active resolution',
  })
  grantAuthority(
    @CurrentUser() user: RequestUser,
    @Param('institutionId') institutionId: string,
  ...
  @ApiParam({ name: 'institutionId', type: String })
  @ApiOperation({
    summary: 'Revoke stamp authority from a member — institution admin only',
  })
  revokeAuthority(
    @CurrentUser() user: RequestUser,
    @Param('institutionId') institutionId: string,
